...
.L3:
	...
	strb	r2, [r3]
.L2:
	.loc 1 71 44 discriminator 1
	ldr	r3, [sp]
	subs	r2, r3, #1
	str	r2, [sp]
	.loc 1 71 41 discriminator 1
	cmp	r3, #0
	bne	.L3
	.loc 1 72 1
	nop
...
.L53:
	...
	cmp	r3, #0
	beq	.L54
	.loc 1 277 36 discriminator 1
	ldr	r3, [sp, #72]
	ldr	r3, [r3, #240]
	.loc 1 277 30 discriminator 1
	cmp	r3, #0
	bne	.L55
.L54:
	.loc 1 280 12
...
.L73:
	...
	cmp	r2, r3
	bne	.L74
	.loc 1 462 29 discriminator 1
	ldr	r3, [sp, #72]
	ldr	r0, [r3, #36]
	.loc 1 462 41 discriminator 1
	ldr	r1, [sp, #32]
	.loc 1 462 9 discriminator 1
	ldr	r3, [sp, #72]
	ldr	r3, [r3, #32]
	mov	r2, r3
	bl	memcmp
...
.LFE15:
	...
	.align	2
.LC0:
	.ascii	"-----END X509 CRL-----\000"
	.align	2
.LC1:
	.ascii	"-----BEGIN X509 CRL-----\000"
...
.LFE17:
	...
	.align	2
.LC2:
	.ascii	"%sCRL version   : %d\000"
	.align	2
.LC3:
	.ascii	"\012%sissuer name   : \000"
	.align	2
.LC4:
	.ascii	"\012%sthis update   : %04d-%02d-%02d %02d:%02d:%02d"
	.ascii	"\000"
	.align	2
.LC5:
	.ascii	"\012%snext update   : %04d-%02d-%02d %02d:%02d:%02d"
	.ascii	"\000"
	.align	2
.LC6:
	.ascii	"\012%sRevoked certificates:\000"
	.align	2
.LC7:
	.ascii	"\012%sserial number: \000"
	.align	2
.LC8:
	.ascii	" revocation date: %04d-%02d-%02d %02d:%02d:%02d\000"
	.align	2
.LC9:
...
.LCFI24:
	...
	cmp	r3, #0
	blt	.L102
	.loc 1 594 5 is_stmt 0 discriminator 2
	ldr	r3, [sp, #40]
	ldr	r2, [sp, #52]
	cmp	r2, r3
	bhi	.L103
.L102:
	.loc 1 594 5 discriminator 3
	ldr	r3, .L130+4
	b	.L104
.L103:
	.loc 1 594 5 discriminator 4
	ldr	r3, [sp, #40]
	ldr	r2, [sp, #52]
	subs	r3, r2, r3
	str	r3, [sp, #52]
	...
	add	r3, r3, r2
	str	r3, [sp, #48]
	.loc 1 596 11 is_stmt 1 discriminator 4
	ldr	r3, [sp, #28]
	ldr	r2, .L130+8
	ldr	r1, [sp, #52]
	ldr	r0, [sp, #48]
	...
	cmp	r3, #0
	blt	.L105
	.loc 1 597 5 is_stmt 0 discriminator 2
	ldr	r3, [sp, #40]
	ldr	r2, [sp, #52]
	cmp	r2, r3
	bhi	.L106
.L105:
	.loc 1 597 5 discriminator 3
	ldr	r3, .L130+4
	b	.L104
.L106:
	.loc 1 597 5 discriminator 4
	...
	add	r3, r3, r2
	str	r3, [sp, #48]
	.loc 1 598 11 is_stmt 1 discriminator 4
	ldr	r3, [sp, #24]
	adds	r3, r3, #52
	mov	r2, r3
	ldr	r1, [sp, #52]
	...
	str	r0, [sp, #40]
	.loc 1 599 5 discriminator 4
	ldr	r3, [sp, #40]
	cmp	r3, #0
	blt	.L107
	.loc 1 599 5 is_stmt 0 discriminator 2
	ldr	r3, [sp, #40]
	ldr	r2, [sp, #52]
	cmp	r2, r3
	bhi	.L108
.L107:
	.loc 1 599 5 discriminator 3
	ldr	r3, .L130+4
	b	.L104
.L108:
	.loc 1 599 5 discriminator 4
	...
	add	r3, r3, r2
	str	r3, [sp, #48]
	.loc 1 601 11 is_stmt 1 discriminator 4
	ldr	r3, [sp, #24]
	ldr	r3, [r3, #84]
	ldr	r2, [sp, #24]
	ldr	r2, [r2, #88]
...
.L110:
	...
	add	r3, r3, r2
	str	r3, [sp, #48]
	.loc 1 608 11 is_stmt 1 discriminator 4
	ldr	r3, [sp, #24]
	ldr	r3, [r3, #108]
	ldr	r2, [sp, #24]
	ldr	r2, [r2, #112]
	...
	bl	snprintf
	str	r0, [sp, #40]
	.loc 1 613 5 discriminator 4
	ldr	r3, [sp, #40]
	cmp	r3, #0
	blt	.L111
	.loc 1 613 5 is_stmt 0 discriminator 2
	ldr	r3, [sp, #40]
	ldr	r2, [sp, #52]
	cmp	r2, r3
	bhi	.L112
.L111:
	.loc 1 613 5 discriminator 3
	ldr	r3, .L130+4
	b	.L104
.L112:
	.loc 1 613 5 discriminator 4
	...
	add	r3, r3, r2
	str	r3, [sp, #48]
	.loc 1 615 11 is_stmt 1 discriminator 4
	ldr	r3, [sp, #24]
	adds	r3, r3, #132
	str	r3, [sp, #44]
	.loc 1 617 11 discriminator 4
	ldr	r3, [sp, #28]
	ldr	r2, .L130+20
	ldr	r1, [sp, #52]
	ldr	r0, [sp, #48]
	...
	cmp	r3, #0
	blt	.L113
	.loc 1 619 5 is_stmt 0 discriminator 2
	ldr	r3, [sp, #40]
	ldr	r2, [sp, #52]
	cmp	r2, r3
	bhi	.L114
...
.L114:
	...
	add	r3, r3, r2
	str	r3, [sp, #48]
	.loc 1 621 10 is_stmt 1 discriminator 4
	b	.L115
.L123:
	.loc 1 623 15
	ldr	r3, [sp, #28]
	...
	cmp	r3, #0
	blt	.L116
	.loc 1 625 9 is_stmt 0 discriminator 2
	ldr	r3, [sp, #40]
	ldr	r2, [sp, #52]
	cmp	r2, r3
	bhi	.L117
...
.L117:
	...
	add	r3, r3, r2
	str	r3, [sp, #48]
	.loc 1 627 15 is_stmt 1 discriminator 4
	ldr	r3, [sp, #44]
	adds	r3, r3, #12
	mov	r2, r3
	ldr	r1, [sp, #52]
...
.L119:
	...
	add	r3, r3, r2
	str	r3, [sp, #48]
	.loc 1 630 15 is_stmt 1 discriminator 4
	ldr	r3, [sp, #44]
	ldr	r5, [r3, #24]
	ldr	r3, [sp, #44]
	ldr	r3, [r3, #28]
	...
	bl	snprintf
	str	r0, [sp, #40]
	.loc 1 635 9 discriminator 4
	ldr	r3, [sp, #40]
	cmp	r3, #0
	blt	.L120
	.loc 1 635 9 is_stmt 0 discriminator 2
	ldr	r3, [sp, #40]
	ldr	r2, [sp, #52]
	cmp	r2, r3
	bhi	.L121
.L120:
	.loc 1 635 9 discriminator 3
	ldr	r3, .L130+4
	b	.L104
.L131:
	.align	2
...
.L121:
	...
	add	r3, r3, r2
	str	r3, [sp, #48]
	.loc 1 637 15 is_stmt 1 discriminator 4
	ldr	r3, [sp, #44]
	ldr	r3, [r3, #60]
	str	r3, [sp, #44]
.L115:
	...
	cmp	r3, #0
	beq	.L122
	.loc 1 621 39 discriminator 1
	ldr	r3, [sp, #44]
	ldr	r3, [r3, #4]
	.loc 1 621 26 discriminator 1
	cmp	r3, #0
	bne	.L123
.L122:
	.loc 1 640 11
	...
	cmp	r3, #0
	blt	.L124
	.loc 1 641 5 is_stmt 0 discriminator 2
	ldr	r3, [sp, #40]
	ldr	r2, [sp, #52]
	cmp	r2, r3
	bhi	.L125
.L124:
	.loc 1 641 5 discriminator 3
	ldr	r3, .L132+4
	b	.L104
.L125:
	.loc 1 641 5 discriminator 4
	ldr	r3, [sp, #40]
	ldr	r2, [sp, #52]
	subs	r3, r2, r3
	str	r3, [sp, #52]
	...
	add	r3, r3, r2
	str	r3, [sp, #48]
	.loc 1 643 11 is_stmt 1 discriminator 4
	ldr	r3, [sp, #24]
	add	r1, r3, #28
	ldr	r3, [sp, #24]
	ldrb	r0, [r3, #233]	@ zero_extendqisi2
	ldr	r3, [sp, #24]
	ldrb	r3, [r3, #232]	@ zero_extendqisi2
	.loc 1 644 33 discriminator 4
	ldr	r2, [sp, #24]
	ldr	r2, [r2, #236]
	.loc 1 643 11 discriminator 4
	str	r2, [sp, #4]
	str	r3, [sp]
	mov	r3, r0
	mov	r2, r1
	...
	str	r0, [sp, #40]
	.loc 1 645 5 discriminator 4
	ldr	r3, [sp, #40]
	cmp	r3, #0
	blt	.L126
	.loc 1 645 5 is_stmt 0 discriminator 2
	ldr	r3, [sp, #40]
	ldr	r2, [sp, #52]
	cmp	r2, r3
	bhi	.L127
...
.L127:
	...
	add	r3, r3, r2
	str	r3, [sp, #48]
	.loc 1 647 11 is_stmt 1 discriminator 4
	ldr	r2, .L132+8
	ldr	r1, [sp, #52]
	ldr	r0, [sp, #48]
	bl	snprintf
	str	r0, [sp, #40]
	.loc 1 648 5 discriminator 4
	ldr	r3, [sp, #40]
	cmp	r3, #0
	blt	.L128
	.loc 1 648 5 is_stmt 0 discriminator 2
	ldr	r3, [sp, #40]
	ldr	r2, [sp, #52]
	cmp	r2, r3
	bhi	.L129
.L128:
	.loc 1 648 5 discriminator 3
	ldr	r3, .L132+4
	b	.L104
.L129:
	.loc 1 648 5 discriminator 4
	...
	add	r3, r3, r2
	str	r3, [sp, #48]
	.loc 1 650 26 is_stmt 1 discriminator 4
	ldr	r2, [sp, #32]
	ldr	r3, [sp, #52]
	subs	r3, r2, r3
.L104:
...
.Letext0:
	...
	.file 10 "../../../../../../external/mbedtls/include/mbedtls/x509_crl.h"
...
.Ldebug_abbrev0:
	...
	.4byte	0xeca
	.4byte	0x994
	.ascii	"mbedtls_x509_crl_free\000"
	.4byte	0xa2e
	.ascii	"mbedtls_x509_crl_init\000"
	.4byte	0xa56
	.ascii	"mbedtls_x509_crl_info\000"
	.4byte	0xafa
	.ascii	"mbedtls_x509_crl_parse_file\000"
	.4byte	0xb64
	.ascii	"mbedtls_x509_crl_parse\000"
	.4byte	0xbf0
	.ascii	"mbedtls_x509_crl_parse_der\000"
	.4byte	0xcbb
	.ascii	"x509_get_entries\000"
	.4byte	0xd5c
	.ascii	"x509_get_crl_entry_ext\000"
	.4byte	0xdc6
	.ascii	"x509_get_crl_ext\000"
	.4byte	0xe2a
	.ascii	"x509_crl_get_version\000"
	.4byte	0xe85
