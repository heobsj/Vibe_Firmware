...
mbedtls_zeroize:
.LFB10:
	.file 1 "C:\\Users\\zeste\\Desktop\\CEEDUP\\develop\\nRF52840-fw\\nRF5_SDK_15.3.0_59ac345\\external\\mbedtls\\library\\x509write_csr.c"
	.loc 1 47 50
...
.LFE18:
	...
	.align	2
.LC2:
	.ascii	"*\206H\206\367\015\001\011\016\000"
...
.L30:
	...
	b	.L51
.L31:
	.loc 1 154 9 discriminator 2
	ldr	r3, [sp, #3204]
	ldr	r2, [sp, #3200]
	add	r3, r3, r2
	str	r3, [sp, #3200]
	.loc 1 157 9 is_stmt 1 discriminator 2
	add	r1, sp, #36
	addw	r3, sp, #3176
	ldr	r2, [sp, #3200]
	mov	r0, r3
...
.L32:
	...
	add	r3, r3, r2
	str	r3, [sp, #3200]
	.loc 1 158 9 is_stmt 1 discriminator 2
	add	r1, sp, #36
	addw	r3, sp, #3176
	movs	r2, #49
	mov	r0, r3
	...
	cmp	r3, #0
	bge	.L33
	.loc 1 158 9 is_stmt 0 discriminator 1
	ldr	r3, [sp, #3204]
	b	.L51
.L33:
	...
	cmp	r3, #0
	bge	.L34
	.loc 1 161 9 is_stmt 0 discriminator 1
	ldr	r3, [sp, #3204]
	b	.L51
.L34:
	.loc 1 161 9 discriminator 2
	ldr	r3, [sp, #3204]
	ldr	r2, [sp, #3200]
	add	r3, r3, r2
	str	r3, [sp, #3200]
	.loc 1 164 9 is_stmt 1 discriminator 2
	add	r1, sp, #36
	addw	r3, sp, #3176
	ldr	r2, [sp, #3200]
	mov	r0, r3
	...
	cmp	r3, #0
	bge	.L35
	.loc 1 164 9 is_stmt 0 discriminator 1
	ldr	r3, [sp, #3204]
	b	.L51
.L35:
	.loc 1 164 9 discriminator 2
	ldr	r3, [sp, #3204]
	ldr	r2, [sp, #3200]
	add	r3, r3, r2
	str	r3, [sp, #3200]
	.loc 1 165 9 is_stmt 1 discriminator 2
	add	r1, sp, #36
	addw	r3, sp, #3176
	movs	r2, #48
	mov	r0, r3
	...
	cmp	r3, #0
	bge	.L36
	.loc 1 165 9 is_stmt 0 discriminator 1
	ldr	r3, [sp, #3204]
	b	.L51
.L36:
	.loc 1 165 9 discriminator 2
	ldr	r3, [sp, #3204]
	ldr	r2, [sp, #3200]
	add	r3, r3, r2
	str	r3, [sp, #3200]
...
.L38:
	...
	add	r3, r3, r2
	str	r3, [sp, #3200]
	.loc 1 173 5 is_stmt 1 discriminator 2
	add	r3, sp, #28
	ldr	r3, [r3]
	ldr	r0, [r3]
	ldr	r2, [sp, #3176]
	...
	cmp	r3, #0
	bge	.L39
	.loc 1 173 5 is_stmt 0 discriminator 1
	ldr	r3, [sp, #3204]
	b	.L51
.L39:
	.loc 1 173 5 discriminator 2
	ldr	r3, [sp, #3204]
	ldr	r2, [sp, #3192]
	add	r3, r3, r2
	str	r3, [sp, #3192]
...
.L40:
	...
	add	r3, r3, r2
	str	r3, [sp, #3200]
	.loc 1 186 5 is_stmt 1 discriminator 2
	add	r1, sp, #36
	addw	r3, sp, #3176
	movs	r2, #0
	mov	r0, r3
	...
	cmp	r3, #0
	bge	.L41
	.loc 1 186 5 is_stmt 0 discriminator 1
	ldr	r3, [sp, #3204]
	b	.L51
.L41:
...
.L43:
	...
	add	r3, r3, r2
	str	r3, [sp, #3200]
	.loc 1 195 5 is_stmt 1 discriminator 2
	add	r3, sp, #28
	ldr	r3, [r3]
	...
	ldr	r2, [sp, #3200]
	bl	mbedtls_md
	.loc 1 197 38 discriminator 2
	add	r3, sp, #28
	ldr	r3, [r3]
	ldr	r3, [r3]
	.loc 1 197 14 discriminator 2
	mov	r0, r3
	bl	mbedtls_pk_get_type
	mov	r3, r0
	strb	r3, [sp, #3199]
	.loc 1 198 7 discriminator 2
	ldrb	r3, [sp, #3199]	@ zero_extendqisi2
	cmp	r3, #2
	bne	.L44
	.loc 1 199 16
	movs	r3, #4
...
.L44:
	...
	addw	r3, sp, #3180
	add	r2, sp, #3184
	ldrb	r0, [sp, #3199]	@ zero_extendqisi2
...
.L47:
	...
	add	r3, r3, r2
	str	r3, [sp, #3188]
	.loc 1 216 28 is_stmt 1 discriminator 2
	ldr	r2, [sp, #3172]
	add	r3, sp, #24
	ldr	r3, [r3]
	subs	r3, r2, r3
	.loc 1 216 15 discriminator 2
	mov	r2, r3
	.loc 1 216 7 discriminator 2
	ldr	r3, [sp, #3200]
	cmp	r3, r2
	bls	.L48
	.loc 1 217 15
...
.L49:
	...
	b	.L51
.L50:
	.loc 1 224 5 discriminator 2
	ldr	r3, [sp, #3204]
	ldr	r2, [sp, #3200]
	add	r3, r3, r2
	str	r3, [sp, #3200]
	.loc 1 227 13 is_stmt 1 discriminator 2
	ldr	r3, [sp, #3200]
.L51:
...
.LFE19:
	...
	.align	2
.LC3:
	.ascii	"-----END CERTIFICATE REQUEST-----\012\000"
	.align	2
.LC4:
	.ascii	"-----BEGIN CERTIFICATE REQUEST-----\012\000"
...
.Letext0:
	...
	.file 6 "../../../../../../external/mbedtls/include/mbedtls/md.h"
	.file 7 "../../../../../../external/mbedtls/include/mbedtls/pk.h"
	.file 8 "../../../../../../external/mbedtls/include/mbedtls/x509_csr.h"
...
.Ldebug_abbrev0:
	...
	.4byte	0x81e
	.ascii	"mbedtls_x509write_csr_pem\000"
	.4byte	0x8ce
	.ascii	"mbedtls_x509write_csr_der\000"
	.4byte	0xa2e
	.ascii	"mbedtls_x509write_csr_set_ns_cert_type\000"
	.4byte	0xaa2
	.ascii	"mbedtls_x509write_csr_set_key_usage\000"
	.4byte	0xb06
	.ascii	"mbedtls_x509write_csr_set_extension\000"
	.4byte	0xb6c
	.ascii	"mbedtls_x509write_csr_set_subject_name\000"
	.4byte	0xba5
	.ascii	"mbedtls_x509write_csr_set_key\000"
	.4byte	0xbda
	.ascii	"mbedtls_x509write_csr_set_md_alg\000"
	.4byte	0xc0f
	.ascii	"mbedtls_x509write_csr_free\000"
	.4byte	0xc35
	.ascii	"mbedtls_x509write_csr_init\000"
	.4byte	0xc5b
	...
	.4byte	0x7c4
	.ascii	"mbedtls_x509write_csr\000"
	.4byte	0x812
	.ascii	"mbedtls_x509write_csr\000"
	.4byte	0
...
.Ldebug_macro0:
	...
	.uleb128 0
	.uleb128 0x1
	.file 9 "../../../../../../external/nrf_tls/mbedtls/nrf_crypto/config/nrf_crypto_mbedtls_config.h"
	.byte	0x3
	.uleb128 0x1e
	.uleb128 0x9
	.byte	0x7
	.4byte	.Ldebug_macro3
	.file 10 "../../../../../../components/libraries/l8w8jwt/lib/mbedtls/include/mbedtls/check_config.h"
	.byte	0x3
	.uleb128 0xd0e
	.uleb128 0xa
	.byte	0x5
	...
	.uleb128 0x18
	.4byte	.LASF620
	.file 12 "../../../../../../external/mbedtls/include/mbedtls/x509.h"
	.byte	0x3
	.uleb128 0x20
	.uleb128 0xc
	.byte	0x5
	...
	.4byte	.Ldebug_macro6
	.byte	0x4
	.file 13 "../../../../../../external/mbedtls/include/mbedtls/bignum.h"
	.byte	0x3
	.uleb128 0x23
	.uleb128 0xd
	.byte	0x5
	.uleb128 0x18
	.4byte	.LASF649
	.file 14 "C:/Program Files/SEGGER/SEGGER Embedded Studio for ARM 4.20/include/stdint.h"
	.byte	0x3
	.uleb128 0x21
	.uleb128 0xe
	.byte	0x7
	...
	.byte	0x4
	.file 20 "../../../../../../external/mbedtls/include/mbedtls/asn1write.h"
	.byte	0x3
	.uleb128 0x25
	.uleb128 0x14
	.byte	0x7
	...
	.byte	0x4
	.file 21 "C:/Program Files/SEGGER/SEGGER Embedded Studio for ARM 4.20/include/string.h"
	.byte	0x3
	.uleb128 0x27
	.uleb128 0x15
	.byte	0x5
	...
	.4byte	.LASF1080
	.byte	0x4
	.file 22 "C:/Program Files/SEGGER/SEGGER Embedded Studio for ARM 4.20/include/stdlib.h"
	.byte	0x3
	.uleb128 0x28
	.uleb128 0x16
	.byte	0x7
	...
	.byte	0x4
	.file 23 "../../../../../../external/mbedtls/include/mbedtls/pem.h"
	.byte	0x3
	.uleb128 0x2b
	.uleb128 0x17
	.byte	0x7
...
.LASF1247:
	...
	.ascii	"ibrary\\x509write_csr.c\000"
.LASF103:
...
.LASF1180:
	.ascii	"long long int\000"
.LASF1096:
	.ascii	"PEM_BEGIN_CSR \"-----BEGIN CERTIFICATE REQUEST-----"
	.ascii	"\\n\"\000"
.LASF1150:
	.ascii	"__mbstate_s\000"
.LASF403:
...
.LASF1097:
	.ascii	"PEM_END_CSR \"-----END CERTIFICATE REQUEST-----\\n\""
	.ascii	"\000"
.LASF927:
